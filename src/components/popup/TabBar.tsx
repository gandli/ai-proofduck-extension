      ...
      {TABS.map((tab, index) => {
        ...
        return (
          <button
            ...
            className={`
              flex-1 flex items-center justify-center gap-1.5 py-2.5 px-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-orange focus-visible:ring-inset
