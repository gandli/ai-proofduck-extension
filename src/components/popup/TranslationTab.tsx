        ...
        <div className="flex-1 relative">
          ...
          {inputText && !loading && (
            <button
              ...
              className="absolute top-2 right-2 p-1 text-gray-400 hover:text-gray-600 rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-brand-orange/50 bg-white"
