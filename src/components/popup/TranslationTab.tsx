        ...
        <div className="flex-1 relative">
          ...
          {inputText && !loading && (
            <button
              ...
              className="absolute top-2 right-2 p-1.5 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-md transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-orange/50"
              aria-label={t('clearText') || '清空文本'}
              title={t('clearText') || '清空文本'}
              type="button"
            >
              <svg
