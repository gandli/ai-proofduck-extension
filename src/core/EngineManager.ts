...
export class EngineManager {
  ...
  async getAvailableEngines(): Promise<TranslationEngine[]> {
    ...
    // Expected impact: Check time is determined by the slowest engine instead of the sum of all checks
    await Promise.all(
  ...
  async getEngineInfos(): Promise<EngineInfo[]> {
    ...
    // ⚡ Bolt: Parallelized availability checks using Promise.all
