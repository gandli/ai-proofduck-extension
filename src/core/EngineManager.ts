...
export class EngineManager {
  ...
  async getAvailableEngines(): Promise<TranslationEngine[]> {
    // ⚡ Bolt Optimization: Parallelize engine availability checks
    const enginesList = Array.from(this.engines.values());
  ...
  async getEngineInfos(): Promise<EngineInfo[]> {
    // ⚡ Bolt Optimization: Parallelize engine information retrieval
    const enginesList = Array.from(this.engines.values());
