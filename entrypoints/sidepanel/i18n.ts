interface Translation {
    ...
    tone_label: string;
    detail_label: string;
    translate_fallback_label?: string;
    translate_fallback_none?: string;
    translate_fallback_google?: string;
    translate_fallback_mymemory?: string;
    save_btn: string;
    wasm_warning: string;
    loading_tip: string;
    ...
    fetch_page_content: string;
    translate_full_page: string;
    translate_full_page_short: string;
    chrome_ai_guidance_title?: string;
    chrome_ai_guidance_steps?: string[];
    fallback_free_api_btn?: string;
    fallback_free_api_note?: string;
    api_key_hint?: string;
    preset_openrouter_free?: string;
    preset_cloudflare?: string;
    preset_cloudflare_hint?: string;
}
...
export const translations: Record<string, Translation> = {
    '中文': {
        ...
        tone_label: '润色语气',
        detail_label: '扩写详细度',
        translate_fallback_label: '翻译兜底服务',
        translate_fallback_none: '不使用（严格走 AI）',
        translate_fallback_google: 'Google 免费翻译接口',
        translate_fallback_mymemory: 'MyMemory 免费翻译接口',
        save_btn: '保存并应用设置',
        ...
        engine_chrome_ai: 'Chrome 内置 AI (Gemini Nano)',
    ...
    'English': {
        ...
        translate_fallback_label: 'Translation Fallback',
        translate_fallback_none: 'Disabled (AI only)',
        translate_fallback_google: 'Google free translate endpoint',
        translate_fallback_mymemory: 'MyMemory free translate API',
        ...
        engine_chrome_ai: 'Chrome Built-in AI (Gemini Nano)',
    ...
    '日本語': {
        ...
        engine_chrome_ai: 'Chrome 内蔵 AI (Gemini Nano)',
    ...
    '한국어': {
        ...
        engine_chrome_ai: 'Chrome 내장 AI (Gemini Nano)',
    ...
    'Français': {
        ...
        engine_chrome_ai: 'IA intégrée Chrome (Gemini Nano)',
    ...
    'Español': {
        ...
        engine_wasm: 'WASM local (Compatible)',
        engine_chrome_ai: 'IA integrada de Chrome (Gemini Nano)',
