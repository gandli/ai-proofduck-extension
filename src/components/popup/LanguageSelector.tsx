  ...
  return (
    <div className="flex items-center gap-2" role="group" aria-label="语言选择">
      ...
      <button
        ...
        className={`
          p-2 rounded-lg border border-gray-300 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-orange/50 focus-visible:ring-offset-2
