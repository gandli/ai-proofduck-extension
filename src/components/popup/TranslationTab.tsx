      ...
      <div className="flex-1 p-4 flex flex-col min-h-0">
        <div className="flex-1 relative">
          ...
          {inputText && !loading && (
            <button
              onClick={handleClear}
              className="absolute top-2 right-2 p-1.5 text-gray-400 hover:text-gray-600 rounded-md hover:bg-gray-100 transition-colors focus:outline-none focus:ring-2 focus:ring-brand-orange/50"
              aria-label={t('clearText') || '清空内容'}
              title={t('clearText') || '清空内容'}
              type="button"
            >
              <svg
