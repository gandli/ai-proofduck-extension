...
**Vulnerability:** Raw error objects were being logged directly to `console.error` in `src/core/EngineManager.ts`, which could potentially expose stack traces or sensitive environment variables contained within the error object.
