      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200">
          ...
          <button
            ref={closeButtonRef}
            onClick={onClose}
            className="p-1.5 rounded-lg hover:bg-gray-100 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-orange" title={t('close') || '关闭'}
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <button
                            ...
                            className={`
                              relative w-10 h-6 rounded-full transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-orange focus-visible:ring-offset-1
                              ${engine.enabled ? 'bg-brand-orange' : 'bg-gray-300'}
                            `}
                            role="switch"
                            aria-checked={engine.enabled}
                            aria-label={`${engine.name} 开关`} title={`${engine.name} 开关`}
                            type="button"
                          >
                            <span
                              className={`
