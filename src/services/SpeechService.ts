...
class EdgeTTSProvider {
  ...
  /**
   * 生成 GUID
   * Security: Use cryptographically secure random number generation when possible.
   * Math.random() is predictable and insufficient for secure identifiers.
   */
  private generateGuid(): string {
    ...
    // Ultimate fallback if crypto is not available
    return 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx'.replace(/[xy]/g, (c) => {
