...
// Hoist compiled regex with alternation to avoid recompilation and multiple string traversals
...
export function formatUserPrompt(text: string, mode: string, targetLang: string): string {
    // Sanitize input by removing structural tags used in the prompt using a single pass
