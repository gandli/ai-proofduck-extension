    ...
    >
      ...
      <div className="px-4 pb-4">
        <button
          ...
          className={`
            w-full py-3 rounded-lg font-medium text-white transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-brand-orange/50
