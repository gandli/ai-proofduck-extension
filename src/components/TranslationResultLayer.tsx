...
export function TranslationResultLayer({
  ...
  // Replaced useCallback + immediate invocation with useMemo to prevent unnecessary recalculations
  // on every render (e.g., during streaming updates), reducing CPU usage.
  // Also added window existence check to prevent SSR/test crashes.
  const { x, y } = useMemo(() => {
