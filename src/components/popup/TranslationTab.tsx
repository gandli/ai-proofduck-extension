      ...
      <div className="flex-1 p-4 flex flex-col min-h-0">
        <div className="flex-1 relative">
          <textarea
            ...
            className={`w-full h-full resize-none rounded-lg border border-gray-300 p-3 text-sm focus:outline-none focus:ring-2 focus:ring-brand-orange/50 focus:border-brand-orange ${inputText.length > 0 ? 'pr-10' : ''}`}
            disabled={loading}
          ...
          {inputText.length > 0 && !loading && (
            <button
              ...
              className="absolute top-2 right-2 p-1.5 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-md transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-orange"
              aria-label={t('clear') || '清空文本'}
              title={t('clear') || '清空文本'}
              type="button"
            >
              <svg
