...
export function TranslationResultLayer({
  ...
  // ⚡ Bolt Optimization: Use useMemo instead of an immediately invoked function
  // to avoid recalculating window dimensions ~33 times per second during streaming mode
  // 计算浮层位置（确保在可视区域内）
  const { x, y } = useMemo(() => {
